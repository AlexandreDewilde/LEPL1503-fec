...
void test_gf_256_gaussian_elimination_zero() {
    ...
    uint8_t A[3][3] = { {0,0,0}, {0,0,0}, {0,0,0}};
    uint8_t b[3][3] = { {0,0,0} };
    uint8_t ans[3][1] = { {0}, {0}, {0} };
    ...
    gf_256_gaussian_elimination(A_double_pointers, b_double_pointers, 3, 1);
    CU_ASSERT_EQUAL(0, compare_2Darray(b_double_pointers, ans_double_pointers, 3, 1));
}
